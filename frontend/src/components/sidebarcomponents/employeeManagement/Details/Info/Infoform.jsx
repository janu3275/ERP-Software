...
import ProfileImageUpload from '../../../../../assets/formcomponents/singleImageUpload/profileImageUpload';



const EmployeeInfoform = ({ selectedEmployee, UpdateEmployee, posItems, departItems }) => {
